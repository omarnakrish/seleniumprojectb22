...
public class OfficeHoursUtils {
    public static int productAdder(WebDriver driver, String category, String product) throws InterruptedException {
    ...
    public static int productRemover(WebDriver driver, String product) throws InterruptedException {
